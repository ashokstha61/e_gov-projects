...
if (!$con) {
  ...
  $sql = "SELECT Customer_id,Sc_No,Customer_fname,phone_no,branch_name,demand_name from Customer_info_nea c,branch b,demand_type d where c.branch_id=b.branch_id and c.demand_id=d.demand_id and c.demand_id=$demand_id ";
