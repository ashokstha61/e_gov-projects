...
if (!$con) {
  ...
  $sql = "SELECT bill_id,bill_amount,discount_amount,penalty,payment_amount,payment_m_name from bill b,payment_method p where b.payment_id=p.payment_id and p.payment_id=$payment_id ";
