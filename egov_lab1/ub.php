...
if (!$con) {
  ...
  $sql = "SELECT bill_id,B_month,B_year,current_read,previous_read,unit_consumed,rate,subtotal,previous_due,total,is_paid from bill where is_paid=0 ";
  ...
  <tr>
    ...
    <td><div class='d1'>Pre.Reading</div></td>
