...
if (!$con) {
  ...
  $sql = "SELECT Customer_id,Sc_No,Custome_fname,phone_no,branch_name,demand_name from Customer_info_nea c,branch b,demand_type d where c.Customer_id=$Customer_id and c.branch_id=b.branch_id and c.deamand_id=d.demand_id ";
